...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/seamm-util-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/seamm-util-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install seamm-util
```
...
It is possible to list all of the versions of `seamm-util` available on your platform:
...
```
pixi search seamm-util --channel conda-forge
```
